...
int main() {
    ...
    switch (choice) {
        case 1: test_list_init(); break;
        case 2: test_list_insert(); break;
        case 3: test_list_insert_after(); break;
        case 4: test_list_insert_before(); break;
        case 5: test_list_delete(); break;
        case 6: test_list_search(); break;
        case 7: test_list_display(); break;
        case 8: test_list_count_nodes(); break;
        case 9: test_list_cleanup(); break;
        case 10: test_list_insert_loop(100); break;  // Example with 100 iterations
        case 11: test_list_insert_after_loop(100); break;
