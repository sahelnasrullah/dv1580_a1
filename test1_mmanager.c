...
void test_zero_alloc_and_free()
{
    ...
    my_assert(block1 != NULL); // Why and how?
    void *block2 = mem_alloc(200);
    my_assert(block2 != NULL);
...
int main() {
    ...
    printf(" 3. test_zero_alloc_and_free - Test allocation of 0 bytes\n");
    printf(" 4. test_resize - Test resizing allocated memory\n");
    printf("Stress and Edge Cases:\n");
    printf(" 5. test_exceed_single_allocation - Test allocation exceeding total memory\n");
    printf(" 6. test_exceed_cumulative_allocation - Test cumulative allocations exceeding total memory\n");
    printf(" 7. test_memory_overcommit - Test memory over-commitment\n");
    printf(" 8. test_boundary_condition - Test boundary conditions\n");
    printf(" 9. test_exact_fit_reuse - Test reuse of exact fit memory\n");
    printf("10. test_double_free - Test handling of double free operations\n");
    printf("11. test_memory_fragmentation - Test handling of memory fragmentation\n");
    printf("12. test_edge_case_allocations - Test allocations at edge conditions\n");
    printf("Advanced Memory Management:\n");
    printf("13. test_frequent_small_allocations - Test frequent small allocations\n");
    printf("14. test_memory_reuse - Test reuse of freed memory\n");
    printf("15. test_block_merging - Test merging of adjacent free blocks\n");
    printf("16. test_non_contiguous_allocation_failure - Ensure failure when no contiguous block fits\n");
    printf("17. test_contiguous_allocation_success - Ensure success when a contiguous block fits\n");
    printf("18. test_random_blocks - Test random block allocations and deallocations\n");
    ...
    switch (choice) {
        ...
        case 2: test_alloc_and_free(); break;
        case 3: test_zero_alloc_and_free(); break;
        case 4: test_resize(); break;
        case 5: test_exceed_single_allocation(); break;
        case 6: test_exceed_cumulative_allocation(); break;
        case 7: test_memory_overcommit(); break;
        case 8: test_boundary_condition(); break;
        case 9: test_exact_fit_reuse(); break;
        case 10: test_double_free(); break;
        case 11: test_memory_fragmentation(); break;
        case 12: test_edge_case_allocations(); break;
        case 13: test_frequent_small_allocations(); break;
        case 14: test_memory_reuse(); break;
        case 15: test_block_merging(); break;
        case 16: test_non_contiguous_allocation_failure(); break;
        case 17: test_contiguous_allocation_success(); break;
        case 18: test_random_blocks(); break;
